...
export function campaignBody(env, brandId) {
  const site = (env.TENDLC_WEBSITE ?? "https://os.sjcarpentryllc.com").trim().replace(/\/$/, "");
  ...
  return {
    ...
    messageFlow:
      "Customers and subcontractors provide their phone numbers directly to SJ Carpentry LLC during project intake, contracting, or ongoing work, and consent to receive project-related messages. Opt-out via STOP at any time.",
    ...
    optinMessage: "You're opted in to SJ Carpentry LLC project messages. Reply HELP for help, STOP to opt out.",
    ...
    privacyPolicyLink: `${site}/privacy`,
    termsAndConditionsLink: `${site}/terms`,
  };
}
