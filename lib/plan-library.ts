...
export const FINISH_PRESETS: readonly FinishPreset[] = Object.freeze([
  ...
  fp("cab-cream", "Painted cream cabinet", "#ece2cc", "cabinet", 0.5, 0),
  fp("cab-greige", "Painted greige cabinet", "#c9c0b1", "cabinet", 0.5, 0),
  fp("cab-sage", "Painted sage cabinet", "#98a488", "cabinet", 0.5, 0),
  fp("cab-blue-gray", "Painted blue-gray cabinet", "#6e7e8b", "cabinet", 0.5, 0),
  fp("cab-black", "Painted black cabinet", "#2a2a2a", "cabinet", 0.45, 0),
